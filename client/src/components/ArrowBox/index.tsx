...
function ArrowBox() {
  ...
  return (
    <Box
      data-testid="drawer-arrow-show-more"
      onClick={swtchCurretnStatusToFavorite}
      className={useArrowBoxStyle.classes.boxArrow}
    >
      <Container
        disableGutters
        className={useArrowBoxStyle.classes.containerArrow}
      >
        <img
          src={openDrawerArrow}
