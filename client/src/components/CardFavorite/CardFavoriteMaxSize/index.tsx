...
const CardFavoriteMaxSize: React.FC<CardFavoritePropsMaxSize> = ({
  favoriteItem,
  handleSetIsOpen,
}) => {
  const { id } = useAuth();
  ...
  const coordinatesArray = favoriteItem.coordinates
    .toString()
    .slice(1, -1)
    .split(", ");
  const destination = {
      ...
      >
        ...
        >
          ...
          <img
            ...
            className={useCardFavoriteStyle.classes.imgArrowDown}
