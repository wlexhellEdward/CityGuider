...
export const PlateSearchPlaces = () => {
  const itemsArray = useTypeSelector(
  ...
  return (
    <Box
      ...
      className={usePlateSearchPlacesStyle.classes.platePlaces}
    >
      <Typography className={usePlateSearchPlacesStyle.classes.titleFavorite}>
        Искать:{" "}
      </Typography>
        ...
        {Places.map((item) => {
          return (
            <>
              <SearchPlace
                searchPlace={item}
                isSelected={testIsSelected(item.type)}
              />
            </>
          );
        })}
      ...
      <Box className={usePlateSearchPlacesStyle.classes.SearchActionsBox}>
        <Typography className={usePlateSearchPlacesStyle.classes.titleRadius}>
          В радиусе:{" "}
        </Typography>
        <Box className={usePlateSearchPlacesStyle.classes.containerInputs}>
          <Input
            onChange={handlerSetInputValue}
            value={inputValue}
            className={usePlateSearchPlacesStyle.classes.inputSearch}
          />
          <Typography
            className={usePlateSearchPlacesStyle.classes.spanDescription}
          >
            км
          </Typography>
        </Box>
