...
export const RegisterForm: React.FC = () => {
  ...
  const formValidity = useTypeSelector(
    (state) => state.registerSlice.formValidity
  );
  const auth = getAuth();
  ...
  return (
    <>
      <Box className={useRegisterFormStyle.classes.containerRegister}>
        ...
        <Typography
          className={useRegisterFormStyle.classes.titleForm}
          component="h1"
          variant="h5"
        >
          Регистрация
        ...
        <Box
          component="form"
          className={useRegisterFormStyle.classes.formRegister}
          noValidate
          ...
          <Box className={useRegisterFormStyle.classes.featActionForm}>
            <Box className={useRegisterFormStyle.classes.otherMethodSignIn}>
              <Button
                ...
                className={useRegisterFormStyle.classes.btnWithIcons}
            ...
            <Link
              className={useRegisterFormStyle.classes.supportActionTitle}
              href="/login"
              variant="body2"
            >
