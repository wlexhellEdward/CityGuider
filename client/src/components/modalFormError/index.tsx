    ...
    return (
        ...
        >
            <Box className={useModalFormErrorStyle.classes.wrapperModal}>
                <ErrorOutlineIcon className={useModalFormErrorStyle.classes.errorIcon}/>
                <Typography className={useModalFormErrorStyle.classes.titleError} id="modal-modal-title" variant="h6" component="h2">
                    {type}
                </Typography>
                <Typography className={useModalFormErrorStyle.classes.descriptionError} id="modal-modal-description" >
                    {message}
                </Typography>
            </Box>
        </Modal>
