...
export const AsideListItems = () => {
  ...
  const { status: currentStatus } = useTypeSelector(
  ...
  return (
    <List className={useAsideStyle.classes.listItems}>
      {currentStatus !== "close" ? (
        <Box className={useAsideStyle.classes.drawerAction}>
          <Button
            ...
            className={useAsideStyle.classes.buttonCloseDrawer}
      ...
      <ListItem className={useAsideStyle.classes.logo}>
        <ListItemIcon
          onClick={handleCloseClick}
          className={useAsideStyle.classes.logo}
        >
      ...
      <ListItem className={useAsideStyle.classes.listItemButton}>
        <Box
          ...
          className={useAsideStyle.classes.containerButton}
          onClick={() => switchCurrentStatus("favorites")}
        >
          {currentStatus !== favorites ? <Favorite /> : <FavoriteSelected />}
        </Box>
        <Box
          data-testid="button-search"
          className={useAsideStyle.classes.containerButton}
          onClick={() => switchCurrentStatus("search")}
        >
          {currentStatus !== search ? <Search /> : <SearchSelected />}
        </Box>
        <Box
          data-testid="button-search"
          className={useAsideStyle.classes.containerButton}
          ...
          {role ? (
            <Link to={URL.admin}>
              <AdminPanelSettingsIcon
                className={useAsideStyle.classes.adminIcon}
              />
            </Link>
          ) : null}
        </Box>
