...
import {
  ...
  increaseZoom,
  setMapTheme,
} from "@/store/reducers/mapSlice/mapSlice";
...
export const MapAction = () => {
  ...
  const handleSwitchMapTheme = () => {
    ...
    const newMapTheme =
      defaultThemeMap === MAP_THEME ? MAP_DARK_THEME : MAP_THEME;
    const newAppTheme =
      pallete === LIGHT_THEME_APP ? DARK_THEME_APP : LIGHT_THEME_APP;
    const map = mapRef;
    if (map) {
        ...
        {isOpenActionMap ? (
          <>
            <Box className={useMapActionStyle.classes.containerMapActions}>
              <IconButton
                onClick={handleClickButtonFindMe}
                className={useMapActionStyle.classes.findMeButton}
              >
                <img
                  src={FindMe}
                  alt={DoesntExistPhoto}
                  title={titles.btnFindMe}
                />
              </IconButton>
              <Box
                className={useMapActionStyle.classes.containerMapActionsZoom}
              >
                <Button
                  className={useMapActionStyle.classes.buttonZoom}
              ...
              <IconButton
                onClick={handleSwitchMapTheme}
                className={useMapActionStyle.classes.switchThemeButton}
              >
                <img
                  src={themeIcon}
                  alt={DoesntExistPhoto}
                  title={titles.btnSwitch}
                />
              </IconButton>
            </Box>
            <Button
              onClick={handleClickSetIsOpenActionMap}
              className={useMapActionStyle.classes.buttonToggleAction}
            >
              {">"}
            </Button>
          </>
